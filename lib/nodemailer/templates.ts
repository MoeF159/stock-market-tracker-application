// HTML email templates are stored as strings so they can be rendered server-side
// and injected with dynamic content (name, intro text, news summaries).  
// Keep HTML inline and minimal to maximize compatibility with email clients.
...
// This template is used for the daily market news email.
// The content is generated by the AI summarization pipeline and inserted into {{newsContent}}.
